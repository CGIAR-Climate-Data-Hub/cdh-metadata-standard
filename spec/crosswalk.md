...
| `themes`               | Encoder output only | Themes Extension `themes` — generated from `cdh.domain`, `cdh.commodities`, `cdh.climate.hazards`, and linked-keyword entries. Not an author-facing input field. | `properties.themes` — same rules                                                                      |
