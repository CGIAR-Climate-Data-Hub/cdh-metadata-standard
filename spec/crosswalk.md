...
| `themes`             | Optional (auto-populated)       | Themes Extension `themes` — auto-populated from `cdh.domain`, `cdh.commodities`, `cdh.climate.hazards`; author-added entries require resolvable scheme URI + concept URIs + descriptions | `properties.themes` — same rules                              |
| `keywords`           | Required                        | `keywords`                                                                        | `properties.keywords`                                              |
...
| `cdh.commodities`               | Agriculture conditional     | Encoded as `themes` entry under scheme `https://cgiar.org/cdh/vocab/commodity` (AGROVOC-resolved); also a `cube:dimensions` / `table:columns` axis if applicable | Encoded as `properties.themes` entry under the same scheme |
| `cdh.climate.mip_era`           | Climate conditional         | `cgiar-cdh:mip_era`                                                        | `properties["cgiar-cdh:mip_era"]`                        |
| `cdh.climate.scenarios`         | Scenario conditional        | `summaries["cgiar-cdh:scenarios"]`; dimension/column if axis               | `properties["cgiar-cdh:scenarios"]`                      |
| `cdh.climate.models`            | Climate conditional         | `summaries["cgiar-cdh:models"]`                                            | `properties["cgiar-cdh:models"]`                         |
| `cdh.climate.hazards`           | Hazard conditional          | Encoded as `themes` entry under scheme `https://cgiar.org/cdh/vocab/hazard` (AGROVOC-resolved) | Encoded as `properties.themes` entry under the same scheme |
| `cdh.climate.baseline`          | Anomaly/projection conditional | `cgiar-cdh:baseline`                                                    | `properties["cgiar-cdh:baseline"]`                       |
| `cdh.climate.bias_adjustment`   | Bias-adjusted conditional   | `cgiar-cdh:bias_adjustment`                                                | `properties["cgiar-cdh:bias_adjustment"]`                |
| `cdh.climate.downscaling`       | Downscaled conditional      | `cgiar-cdh:downscaling`                                                    | `properties["cgiar-cdh:downscaling"]`                    |
